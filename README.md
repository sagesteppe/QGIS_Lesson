...
Download the zip file 'qml_styles' from [here](https://github.com/sagesteppe/QGIS_Lesson/data), and click the little 'download' button. Place this in the same directory as above, and remember to unzip it. 
